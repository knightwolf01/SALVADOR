...
const Banner = () => {
  ...
  return (    <div className='flex bg-primary rounded-2xl shadow-xl px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10 hover:scale-[1.02] transition-all duration-500'>
      {/* ---------- Left Side ---------- */}
