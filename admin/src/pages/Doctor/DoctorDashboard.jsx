...
const DoctorDashboard = () => {
  const { dToken, appointments, dashData, getDashData, getAllAppointments, cancelAppointment } = useContext(AdminContext)
    ...
    <div className='m-5'>
      ...
      <div className='bg-white mt-8 rounded-lg shadow-sm'>
        ...
        <div className='divide-y'>
          {dashData.recentAppointments && dashData.recentAppointments.map((item, index) => (
